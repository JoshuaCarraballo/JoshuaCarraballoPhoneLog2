<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="calls.aspx.vb" Inherits="JoshuaCarraballoPhoneLog2.calls" %>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="#">Calls</a>
            </li>
            <li class="nav-item">
      ...
      <div class="container py-5 h-100">
        ...
        <form id="form1" runat="server" class="shadow-sm p-3 mb-5 bg-white rounded mt-3">
            <div class="form-outline mb-4">
                <h5 class="fw-large" style="letter-spacing: 1px;">Select A Call</h5>
                <!-- Selecting a call record from database -->
                <div class="row mb-4">
                    <div class="col-8">
                        <asp:DropDownList class="mb-4" ID="ddlCallRecord" runat="server" AutoPostBack="True" Height="100%"
                        Width="100%" CausesValidation="True">
                        </asp:DropDownList>
                    </div>
                    <div class="col-4">
                        <asp:Button ID="btnSelectCall" runat="server" class="btn btn-dark btn-lg btn-block" UseSubmitBehavior="false" Text="Select" Width="100%"/>
                    </div>
                </div>

                <!-- Searching a phone record from database -->
                <div class="row mb-2">
                    <div class="col-8">
                        <asp:TextBox ID="compNum" runat="server" class="form-control form-control-lg" placeholder="Search a phone number"></asp:TextBox>
                        <label class="form-label" for="compNum">Phone Number</label>
                    </div>
                    <div class="col-4">
                        <asp:Button ID="btnSearch" runat="server" class="btn btn-dark btn-lg btn-block" UseSubmitBehavior="false" Text="Search" Width="100%"/>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6 mb-2">
                    <asp:TextBox ID="compName" runat="server" class="form-control form-control-lg" ReadOnly></asp:TextBox>
                    <label class="form-label" for="compName">Company Name</label>
                    </div>
                    <div class="col-6 mb-2">
                    <asp:TextBox ID="callDay" runat="server" class="form-control form-control-lg" type="date" required></asp:TextBox>
                    <label class="form-label" for="callDay">Date</label>
                    </div>
                    <div class="col-6 mb-2">
                    <asp:TextBox ID="duration" runat="server" class="form-control form-control-lg" type="number" required></asp:TextBox>
                    <label class="form-label" for="duration">Duration</label>
                    </div>
                    <div class="col-12">
                    <asp:DropDownList ID="ddlEmpRecord" runat="server" AutoPostBack="True" Height="55px"
                    Width="100%" CausesValidation="True">
                    </asp:DropDownList>
